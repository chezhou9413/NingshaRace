...
namespace NingshaRaceLib.Combat.FallingMountainSlash.Flight
{
    ...
    public class PawnFlyer_FallingMountainSlash : PawnFlyer
    {
        ...
        private float landingImpactRadius;
        private float landingAreaDamage;
        private float lockedTargetDamage;
        private DamageDef landingDamageDef;
        private float landingArmorPenetration;
        private float landingScreenShake;

        //函数职责：记录施放瞬间的目标与 Def 参数，供飞行绘制和落地结算使用。
        public void InitializeLandingData(
            Vector3 destination,
            Pawn targetPawn,
            FallingMountainSlashDefExtension settings)
        {
            ...
            attackProgress = settings.attackProgress;
            landingImpactRadius = settings.landingImpactRadius;
            landingAreaDamage = settings.landingAreaDamage;
            lockedTargetDamage = settings.lockedTargetDamage;
            landingDamageDef = settings.landingDamageDef;
            landingArmorPenetration = settings.landingArmorPenetration;
            landingScreenShake = settings.landingScreenShake;
        }
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref attackProgress, "attackProgress");
            Scribe_Values.Look(ref landingImpactRadius, "landingImpactRadius");
            Scribe_Values.Look(ref landingAreaDamage, "landingAreaDamage");
            Scribe_Values.Look(ref lockedTargetDamage, "lockedTargetDamage");
            Scribe_Defs.Look(ref landingDamageDef, "landingDamageDef");
            Scribe_Values.Look(ref landingArmorPenetration, "landingArmorPenetration");
            Scribe_Values.Look(ref landingScreenShake, "landingScreenShake");
        }
        ...
        private DamageInfo CreateLandingDamageInfo(Pawn casterPawn, Thing target, IntVec3 landingCell, float damageAmount)
        {
        ...
        private void ShakeCurrentMapCamera(Map map)
        {
